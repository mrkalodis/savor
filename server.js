...
app.use((req, res, next) => {
  ...
  if (req.user) {
    ...
    res.locals.aiModel = settingsService.get(req.user.id, 'ai_model') || 'llama3.2:1b';
    res.locals.aiApiKey = settingsService.get(req.user.id, 'ai_api_key') || '';
  } else {
    ...
    res.locals.aiModel = 'llama3.2:1b';
    res.locals.aiApiKey = '';
  }
